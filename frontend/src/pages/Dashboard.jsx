...
export default function Dashboard() {
  ...
  // Positive Cases by Purpose (Doughnut or Bar)
  const positiveCasesData = {
    labels: d.positiveCasesByPurpose?.map(x => x.purpose || 'Unknown') || [],
    datasets: [{
      label: 'Positive Cases',
      data: d.positiveCasesByPurpose?.map(x => x.count) || [],
      backgroundColor: [COLORS.deaths, COLORS.warning, COLORS.primary, COLORS.active, COLORS.recovered],
      borderWidth: 0
    }]
  };
