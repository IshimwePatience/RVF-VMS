...
export default function Reports() {
  ...
  if (filters.dateFrom) {
    ...
    const dFrom = new Date(filters.timeFrom ? `${filters.dateFrom} ${filters.timeFrom}:00` : `${filters.dateFrom} 00:00:00`);
    if (!isNaN(dFrom)) queryParams.append('dateFromIso', dFrom.toISOString());
  }
  if (filters.dateTo) {
    queryParams.append('dateTo', filters.dateTo);
    const dTo = new Date(filters.timeTo ? `${filters.dateTo} ${filters.timeTo}:59` : `${filters.dateTo} 23:59:59`);
